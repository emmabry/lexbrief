...
source_docs = []
current_doc = []
with open("./data/eur-lexsum/processed-data/val.source", encoding="utf-8") as f:
    for line in f:
        line = line.strip()
        if line == "":
            if current_doc:
...
target_summaries = []
with open("./data/eur-lexsum/processed-data/val.target", encoding="utf-8") as f:
    for line in f:
...
# Save predictions
with open("./data/eur-lexsum/processed-data/val-legalbert_preds.txt", "w", encoding="utf-8") as f:
    for doc in predictions:
        f.write(" ".join(map(str, doc)) + "\n")

with open("./data/eur-lexsum/processed-data/val-legalbert_summaries.txt", "w", encoding="utf-8") as f:
